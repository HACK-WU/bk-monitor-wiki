web 与 kernel_api 异常链路差异及 BKAPIError 捕获机制，以 Issue rename 重名冲突（REQ-20260803-001）为实际案例。
...
- 符号: `BKAPIError`
- 位置: `bkmonitor/core/drf_resource/contrib/api.py`、`bkmonitor/core/errors/api.py`（code 3301001，`data=上游响应体`）
