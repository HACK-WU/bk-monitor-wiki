...
> 📊 **交互图表**（archify 交付，可切换明暗主题、缩放、按关系追踪、导出 PNG/SVG）：
> - [组件结构图](./archify/rollover-architecture.html) —— 编排层 / 存储层 / 消费层三层结构与别名路由
> - [数据流转图](./archify/alert-doc-dataflow.html) —— 告警文档从接入到查询的完整流转与落点收敛
...
| [archify/rollover-architecture.html](./archify/rollover-architecture.html) | 交互结构图：ILM 组件结构与别名路由（archify 交付，9/9 检查通过） |
| [archify/alert-doc-dataflow.html](./archify/alert-doc-dataflow.html) | 交互数据流转图：告警文档在索引间的流转（archify 交付，9/9 检查通过） |
