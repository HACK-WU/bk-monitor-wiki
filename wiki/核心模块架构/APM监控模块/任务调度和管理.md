...
- [tasks.py:53-379](file://bkmonitor/apm/task/tasks.py#L53-L379)
- [application.py:36-250](file://bkmonitor/apm/models/application.py#L36-L250)
- [datasource.py:56-201](file://bkmonitor/apm/models/datasource.py#L56-L201)
- [profile.py:14-30](file://bkmonitor/apm/models/profile.py#L14-L30)
- [constants.py:42-740](file://bkmonitor/apm/constants.py#L42-L740)
...
- [datasource.py:114-191](file://bkmonitor/apm/models/datasource.py#L114-L191)
...
- [datasource.py:114-134](file://bkmonitor/apm/models/datasource.py#L114-L134)
...
- 应用配置刷新
  ...
  - refresh_apm_application_config(bk_biz_id, app_name, skip_k8s=False)：独立 Celery 任务，刷新单个应用的 APM 配置；skip_k8s 可跳过 K8s 平台配置下发，仅刷新应用级配置缓存。
- 平台配置刷新
...
**图表来源**
- [tasks.py:198-226](file://bkmonitor/apm/task/tasks.py#L198-L226)
...
**图表来源**
- [tasks.py:325-341](file://bkmonitor/apm/task/tasks.py#L325-L341)
- [tasks.py:228-241](file://bkmonitor/apm/task/tasks.py#L228-L241)
...
**图表来源**
- [tasks.py:253-268](file://bkmonitor/apm/task/tasks.py#L253-L268)

**章节来源**
- [tasks.py:243-268](file://bkmonitor/apm/task/tasks.py#L243-L268)
...
**图表来源**
- [tasks.py:291-323](file://bkmonitor/apm/task/tasks.py#L291-L323)
...
- [datasource.py:136-191](file://bkmonitor/apm/models/datasource.py#L136-L191)
