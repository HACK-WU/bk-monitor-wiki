...
- [models/datasource.py:56-1437](file://bkmonitor/apm/models/datasource.py#L56-L1437)
- [models/doris.py:127-1131](file://bkmonitor/apm/models/doris.py#L127-L1131)
...
- [models/datasource.py:176-192](file://bkmonitor/apm/models/datasource.py#L176-L192)
...
- 独占链路备份与恢复：backup_exclusive_link_info 备份、recover_link_info 恢复链路独占信息（_get_backup_link_info 提取 DataID/结果表映射），用于数据源切换/迁移时保全独占链路
- 租户默认 Kafka 集群：_get_default_registered_kafka_cluster_name / _get_default_kafka_cluster_name 按租户或业务选择默认 Kafka 集群
- 指标分组维度：DEFAULT_METRIC_GROUP_DIMENSIONS（scope_name 维度）、is_metric_group_dimensions_enabled 控制是否启用指标分组维度
...
图表来源
- [models/datasource.py:56-192](file://bkmonitor/apm/models/datasource.py#L56-L192)
- [models/datasource.py:193-321](file://bkmonitor/apm/models/datasource.py#L193-L321)
- [models/datasource.py:323-444](file://bkmonitor/apm/models/datasource.py#L323-L444)
- [models/datasource.py:446-839](file://bkmonitor/apm/models/datasource.py#L446-L839)
- [models/datasource.py:1195-1360](file://bkmonitor/apm/models/datasource.py#L1195-L1360)
- [models/datasource.py:1361-1437](file://bkmonitor/apm/models/datasource.py#L1361-L1437)
...
- 存储配置：DorisStorageConfig，支持集群、过期时间、存储类型与Kafka配置；provider 支持 prefer_kafka_cluster_name 参数指定偏好 Kafka 集群，_tenant_kwargs 注入租户级 Kafka 配置
...
图表来源
- [models/datasource.py:1224-1300](file://bkmonitor/apm/models/datasource.py#L1224-L1300)
- [models/doris.py:230-568](file://bkmonitor/apm/models/doris.py#L230-L568)
- [models/doris.py:577-828](file://bkmonitor/apm/models/doris.py#L577-L828)
...
- [models/datasource.py:56-1437](file://bkmonitor/apm/models/datasource.py#L56-L1437)
- [models/topo.py:23-143](file://bkmonitor/apm/models/topo.py#L23-L143)
- [constants.py:17-740](file://bkmonitor/apm/constants.py#L17-L740)
...
章节来源
- [models/datasource.py:839-1129](file://bkmonitor/apm/models/datasource.py#L839-L1129)
...
章节来源
- [models/datasource.py:136-169](file://bkmonitor/apm/models/datasource.py#L136-L169)
- [models/datasource.py:1183-1193](file://bkmonitor/apm/models/datasource.py#L1183-L1193)
- [models/topo.py:38-53](file://bkmonitor/apm/models/topo.py#L38-L53)
- [apps.py:19-23](file://bkmonitor/apm/apps.py#L19-L23)
...
- 初始化内置配置
  ...
  - [migrations/0014_initbuilt_metric_dimensions.py:19-21](file://bkmonitor/apm/migrations/0014_initbuilt_metric_dimensions.py#L19-L21)
- 启停数据源
  - [models/datasource.py:114-135](file://bkmonitor/apm/models/datasource.py#L114-L135)
  - [models/datasource.py:1183-1193](file://bkmonitor/apm/models/datasource.py#L1183-L1193)
- Profile V4 链路接入
  - [models/datasource.py:1224-1300](file://bkmonitor/apm/models/datasource.py#L1224-L1300)
  - [models/doris.py:577-828](file://bkmonitor/apm/models/doris.py#L577-L828)
...
- 配置覆盖与删除策略
  ...
  - [models/config.py:486-545](file://bkmonitor/apm/models/config.py#L486-L545)
- Trace 查询过滤与聚合
  - [models/datasource.py:824-838](file://bkmonitor/apm/models/datasource.py#L824-L838)
  - [models/datasource.py:1020-1079](file://bkmonitor/apm/models/datasource.py#L1020-L1079)
